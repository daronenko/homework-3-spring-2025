...
> [!WARNING]  
> Нет ошибки при нажатии на кнопку "Создать каталог", если не нажата ни одна из кнопок селекта "Добавление позиций"

#### Фид или сообщество

![7](img/7.png)

1. Ошибка "Нужно заполнить" при удалении значения из поля "Ссылка на фид или сообщество"
...
![4](img/4.png)
7. Ошибка "Неверный формат файла" при вводе ссылки, содержащей не фид и не сообщество `https://education.vk.company/`
8. Ошибка "Неверный формат файла" при вводе ссылки на фид или сообщество, не содержащей ни одного товара или услуги
...
> [!WARNING]  
> При вводе цифры после значения `http://` или `https://` в поле "Ссылка на фид или сообщество" в поле подставляется подстрока `0.0.0.0`. Нажатие на кнопку `Delete` ни к чему не приводит (удалить эту подстроку можно только выделив эту подстроку полностью)
...
![11](img/11.png)
3. При нажатии на крестик у загруженного файла фида отображается поле прикрепления файла
4. При актиной галочки "Автоматически удалять UTM-метки" удаляются UTM-метки, которые конфликтуют с метками VK Рекламы
5. Ошибка "Нужно заполнить" под полем прикрепления файла фида при нажатии на кнопку "Создать каталог"
...
4. При нажатии на кнопку "Удалить каталог" открывается модальное окно подтверждения удаления
   ![12](img/12.png)
   - при нажатии не крестик модальное окно закрывается
...
4. При нажатии на кнопку "Применить" выбранные чекбокса сохраняются, модальное окно "Настройка таблицы" закрывается
...
1. При нажатии на кнопку "Создать группу" появляется выпадающий список в двумя вариантами: "Использовать фильтры" и "Выбрать товары вручную"
   ![19](img/19.png)
   - при нажатии на кнопку "Использовать фильтры" открывается окно создания группы, используя фильтры
...
4. При нажатии на кнопку "всем условиям"/"хотя бы одному из условий" открыается выпадающее окно с выбором режима фильтрации
